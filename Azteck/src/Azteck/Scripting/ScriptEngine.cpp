...
namespace Azteck
{
	...
	void ScriptEngine::initMono()
	{
		...
		_data->coreAssembly = loadCSharpAssembly("Resources/Scripts/Azteck-ScriptCore.dll");
		printAssemblyTypes(_data->coreAssembly);

		MonoImage* assemblyImage = mono_assembly_get_image(_data->coreAssembly);
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "Azteck", "Main");
